...
$CFG->dbhost    = getenv('MOODLE_DOCKER_DBHOST');  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('MOODLE_DOCKER_DBNAME');     // database name, eg moodle
$CFG->dbuser    = getenv('MOODLE_DOCKER_DBUSER');   // your database username
$CFG->dbpass    = getenv('MOODLE_DOCKER_DBPASS');   // your database password
...
//      $CFG->sslproxy = true;
$CFG->sslproxy = getenv('MOODLE_DOCKER_SSLPROXY') !== false;
//
